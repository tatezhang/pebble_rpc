...
/* 频率控制(client不做频率控制) */
#define PLOG_FATAL_N_EVERY_SECOND(num, fmt, ...) PLOG_FATAL(fmt, ##__VA_ARGS__)
#define PLOG_ERROR_N_EVERY_SECOND(num, fmt, ...) PLOG_ERROR(fmt, ##__VA_ARGS__)
#define PLOG_INFO_N_EVERY_SECOND(num, fmt,  ...) PLOG_INFO(fmt, ##__VA_ARGS__)
#define PLOG_DEBUG_N_EVERY_SECOND(num, fmt, ...) PLOG_DEBUG(fmt, ##__VA_ARGS__)
#define PLOG_TRACE_N_EVERY_SECOND(num, fmt, ...) PLOG_TRACE(fmt, ##__VA_ARGS__)
