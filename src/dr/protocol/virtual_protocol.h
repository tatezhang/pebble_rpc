...
#ifndef PEBBLE_DR_PROTOCOL_VIRTUALPROTOCOL_H
#define PEBBLE_DR_PROTOCOL_VIRTUALPROTOCOL_H
...
class TProtocolDefaults : public TProtocol {
 ...
 protected:
  TProtocolDefaults(cxx::shared_ptr<TTransport> ptrans)
    : TProtocol(ptrans)
  {}
};
...
class TVirtualProtocol : public Super_ {
 public:
  ...
  uint32_t skip(TType type) {
    ...
    return pebble::dr::protocol::skip(*prot, type);
  }
 ...
 protected:
  TVirtualProtocol(cxx::shared_ptr<TTransport> ptrans)
    : Super_(ptrans)
  {}
};
...
#endif // PEBBLE_DR_PROTOCOL_VIRTUALPROTOCOL_H
