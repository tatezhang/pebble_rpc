...
#include "platform.h"
#include "dr/common/dr_define.h"
#include "dr/transport/transport.h"
...
static inline To bitwise_cast(From from) {
  ...
  // TODO: substitue BOOST_STATIC_ASSERT
...
using pebble::dr::transport::TTransport;
...
class TProtocol {
 public:
  ...
  virtual cxx::shared_ptr<TTransport> getTransport() {
    return ptrans_;
  }
  ...
  inline cxx::shared_ptr<TTransport> getOutputTransport() {
    return ptrans_;
  }
 ...
 protected:
  TProtocol(cxx::shared_ptr<TTransport> ptrans)
    : ptrans_(ptrans)
    , recursion_depth_(0)
...
class TProtocolFactory {
 public:
  ...
  virtual cxx::shared_ptr<TProtocol> getProtocol(cxx::shared_ptr<TTransport> trans) = 0;
};
...
#endif // PEBBLE_DR_PROTOCOL_PROTOCOL_H
