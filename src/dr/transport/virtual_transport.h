...
#ifndef PEBBLE_DR_TRANSPORT_TVIRTUALTRANSPORT_H
#define PEBBLE_DR_TRANSPORT_TVIRTUALTRANSPORT_H
...
public:
    ...
    uint32_t readAll(uint8_t* buf, uint32_t len) {
        ...
        return pebble::dr::transport::readAll(*trans, buf, len);
    }
...
protected:
    ...
    TVirtualTransport(Arg_ const& arg) : Super_(arg) {} // NOLINT
...
#endif // PEBBLE_DR_TRANSPORT_TVIRTUALTRANSPORT_H
