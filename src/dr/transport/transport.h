...
#ifndef PEBBLE_DR_TRANSPORT_TTRANSPORT_H
...
uint32_t readAll(Transport_ &trans, uint8_t* buf, uint32_t len) { // NOLINT
/*
    uint32_t have = 0;
    uint32_t get = 0;
...
public:
     ...
     */
    virtual cxx::shared_ptr<TTransport> getTransport(cxx::shared_ptr<TTransport> trans) {
        return trans;
    }
};
...
#endif // PEBBLE_DR_TRANSPORT_TTRANSPORT_H
